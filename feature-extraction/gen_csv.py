...
def generateSMRI(subject, root_path, save_path = "./features/"):
    gm_path = os.path.join(root_path, f"train/{subject}/segmented/c1anat_X_{subject}_classify_stereolin.nii")
    wm_path = os.path.join(root_path, f"train/{subject}/segmented/c2anat_X_{subject}_classify_stereolin.nii")
    csf_path = os.path.join(root_path, f"train/{subject}/segmented/c3anat_X_{subject}_classify_stereolin.nii")
    empty_path = os.path.join(root_path, f"train/{subject}/segmented/c6anat_X_{subject}_classify_stereolin.nii")
...
def generateFMRI(subject, root_path, save_path = "./features/"):
    fmri_path = os.path.join(root_path, f"train/{subject}/func/sfnwmrda{subject}_session_1_rest_1.nii")
    falff_path = os.path.join(root_path, f"train/{subject}/falff_{subject}_session_1_rest_1.nii")
    reho_path = os.path.join(root_path, f"train/{subject}/reho_{subject}_session_1_rest_1.nii")
    pcc_path = os.path.join(root_path, f"train/{subject}/sbc/pcc_seed_correlation_z.nii")
    mpfc_path = os.path.join(root_path, f"train/{subject}/sbc/mpfc_seed_correlation_z.nii")
    lTPJ_path = os.path.join(root_path, f"train/{subject}/sbc/lTPJ_seed_correlation_z.nii")
    rTPJ_path = os.path.join(root_path, f"train/{subject}/sbc/rTPJ_seed_correlation_z.nii")
